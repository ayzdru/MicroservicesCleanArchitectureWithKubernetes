...
using CleanArchitecture.Services.Order.Infrastructure.Extensions;
...
namespace CleanArchitecture.Services.Order.Infrastructure.Data
{
    public class OrderDbContext : DbContext, IOrderDbContext
    {
        ...
        public OrderDbContext(DbContextOptions<OrderDbContext> options, IMediator mediator, EntitySaveChangesInterceptor entitySaveChangesInterceptor)
              : base(options)
        {
            _mediator = mediator;
